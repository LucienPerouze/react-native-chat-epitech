...
export default class ChatIcon extends Component {
    render() {
        return (
            <Svg height={this.props.height} width={this.props.width} viewBox="0 0 512 512">
                <Svg.Path fill={this.props.color} d="M256,0C114.848,0,0,114.848,0,256c0,49.216,13.792,96.48,39.936,137.216L1.152,490.048
